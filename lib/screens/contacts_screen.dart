...
class _ContactsScreenState extends State<ContactsScreen> {
  Widget _fontScoped(Widget child) =>
      DialerFontScope(surface: DialerFontSurface.contacts, child: child);
  ...
  void initState() {
    ...
    main_app.contactsRefreshTickNotifier.addListener(_handleContactsRefreshTick);
  }

  @override
  void dispose() {
    main_app.contactsRefreshTickNotifier.removeListener(
      _handleContactsRefreshTick,
    );
  ...
  void _handleContactsRefreshTick() {
    if (!mounted) return;
    unawaited(_loadContacts(forceRefresh: true));
  }
  ...
  int get _visibleContactCount => _flatItems.whereType<Contact>().length;
